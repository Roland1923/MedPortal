...
namespace WebApp.Apis
{
    ...
    public class FeedbacksController : Controller
    {
        ...
        public async Task<ActionResult> CreateFeedback([FromBody]FeedbackModel feedback)
        {
            ...
            var instance = Feedback.Create(feedback.Description, feedback.Patient, feedback.Doctor, feedback.Rating);
        ...
        public async Task<ActionResult> UpdateFeedback(Guid id, [FromBody]FeedbackModel feedback)
        {
            ...
            try
            {
                ...
                instance.Update(feedback.Description, feedback.Patient, feedback.Doctor, feedback.Rating);
        ...
        public async Task<ActionResult> DeleteFeedback([FromBody]Feedback feedback)
        {
            try
            {
                var status = await _repository.DeleteAsync(feedback);
                if (!status)
                {
                    return BadRequest(new ApiResponse { Status = false });
                }
